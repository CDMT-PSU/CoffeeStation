...
public final class EditOrderItemDialog extends JDialog {
    private final OrderItem initial;
    ...
    public EditOrderItemDialog(Window owner, OrderItem initial) {
        super(owner);
        ...
        menuItemComboBox.setSelectedItem(initial.getMenuItem());
        ...
        /* this */
        setTitle("Редактировать позицию заказа");
